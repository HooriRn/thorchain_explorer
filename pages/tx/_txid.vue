  ...
  <div class="tx-container">
    ...
    <div class="tx-inner-container">
      <div class="in-container">
        ...
        <div class="tx" v-if="tx.in[0] && tx.in[0].txID" @click="gotoTx(tx.in[0].txID)">{{tx.in[0].txID.slice(0,4)}}...{{tx.in[0].txID.slice(-4)}}</div>
        <div class="break"></div>
      ...
      <div class="out-container" v-if="tx.out[0]">
        ...
        <div class="tx" v-if="tx.out[0].txID" @click="gotoTx(tx.out[0].txID)">{{tx.out[0].txID.slice(0,4)}}...{{tx.out[0].txID.slice(-4)}}</div>
        <div class="break"></div>
